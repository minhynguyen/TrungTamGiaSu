                ...
                <div class="main_service_area sections text-center">
                    ...
                    <div class="col-sm-4">
                        <div class="single_service">
                            ...
                            <a href="{{ route('dangkigs') }}" target="_blank" ><h3>Đăng Kí Làm Gia Sư</h3></a>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="single_service">
                           ...
                           <a href="{{ route('YeuCau.index') }}" target="_blank" ><h3>Đăng Kí Tìm Gia Sư</h3></a>
                       </div>
                   </div>
                   <div class="col-sm-4">
                    <div class="single_service">
                        ...
                        <a href="{{ route('YeuCau.index') }}" target="_blank" ><h3>Hướng Dẫn Nhận Lớp</h3></a>
                    </div>
                </div>
                 ...
                 <div class="single_gellary">
                    <div class="col-sm-3 col-xs-6">
                        <div class="single_gellary_item">
                            <img src="{{asset ('Theme/TrangChu/images/teacher.jpg')}}" width="262", height="270" alt="" />
                            <div class="gellary_overlay">
                                <h4 style="color: red">{{$dk->gs_ten}}</h4>
                                <p>{{$dk->m_ten}}<br />
                                    {{$dk->dk_hocphi}}</p>
                                    <a  href="{{ route('xemdangki.show', ['dangki' => $dk->dk_ma]) }}" target="_blank"><i class="lnr lnr-plus-circle"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section id="gellary" class="gellary">
    <div class="right_about_top_content" style="text-align: center;">
        <h3>THông Tin Phụ Huynh Cần Tìm Gia Sư</h3>
        <div class="separator"></div>
    </div>
    <div class="container">
        <div class="row">
                 ...
                 <div class="single_gellary">
                    <div class="col-sm-3 col-xs-6">
                        <div class="single_gellary_item">
                            <img src="{{asset ('Theme/TrangChu/images/teacher.jpg')}}" width="262", height="270" alt="" />
                            <div class="gellary_overlay">
                                <h4 style="color: red">{{$yc->m_ten}}</h4>
                                <p>{{$yc->tdd_ten}}<br />
                                    {{$yc->ph_ten}}</p>
